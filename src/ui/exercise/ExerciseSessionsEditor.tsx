  ...
  const changeStyle = (style: RecordingStyle) => {
    ...
    if (style === "TEXT") {
      if (item.recording_style === "TEXT") {
        onChange({ ...item, updated_at: nowISO() });
        return;
      }
